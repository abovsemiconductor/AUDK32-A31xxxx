/**
 *******************************************************************************
 * @file        startup_a31c12x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A31C12x
 *
...
#ifndef _STARTUP_A31C12X_H_
#define _STARTUP_A31C12X_H_
...
{
    if(CHIPCONFIG->CHIPID == 0x43311220)
    {
        return (int8_t *)"A31C122 : Code Flash 32KB / SRAM 6KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x43311210)
    {
        return (int8_t *)"A31C121 : Code Flash 16KB / SRAM 6KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
static __inline void PRV_PORT_Init(void)
{
    ...
    PA->MR1 = 0x00UL
              ...
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6 - 0:PA6 1:     2:     3:     4:      7:AN6 */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5 - 0:PA5 1:     2:T6IO 3:     4:      7:AN5 */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4 - 0:PA4 1:     2:     3:     4:      7:AN4 */
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3 - 0:PA3 1:     2:     3:     4:      7:AN3 */
              | (0x00UL << PCU_MR1_P2MUX_Pos);   /* P2 - 0:PA2 1:     2:T6IO 3:     4:      7:AN2 */
    ...
    PB->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6 - 0:PB6 1:TXD1   2:     3:         4:       7:*/
              ...
              | (0x00UL << PCU_MR1_P1MUX_Pos)    /* P1 - 0:PB1 1:RXD10  2:     3:EXT_SYNC 4:MISO10 7:AN9 */
    ...
    PC->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P0MUX_Pos);   /* P0 - 0:PC0 1:     2:T5IO 3:     4:   7:*/
    ...
    PD->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3 - 0:PD3 1:RXD11 2:     3: 4:MISO11 7: */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2 - 0:PD2 1:TXD11 2:     3: 4:MOSI11 7: */
    ...
    PE->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7 - 0:PE7 1:   2:T1IO 3:STBYO 4:AD0E   7: */
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6 - 0:PE6 1:   2:T0IO 3:WDTO  4:AD0S   7: */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5 - 0:PE5 1:   2:T4IO 3:      4:       7: */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4 - 0:PE4 1:   2:T3IO 3:      4:       7: */
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3 - 0:PE3 1:   2:T2IO 3:      4:       7:AN17 */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2 - 0:PE2 1:   2:T4IO 3:      4:       7:AN16 */
    ...
    PF->MR1 = 0x00UL
              | (0x07UL << PCU_MR1_P3MUX_Pos)    /* P3 - 0:PF3 1:     2:     3:CLKO 4:   7:SXOUT */
              | (0x07UL << PCU_MR1_P2MUX_Pos)    /* P2 - 0:PF2 1:     2:     3:     4:   7:SXIN */
              | (0x07UL << PCU_MR1_P1MUX_Pos)    /* P1 - 0:PF1 1:SDA1 2:     3:     4:   7:XIN */
              | (0x07UL << PCU_MR1_P0MUX_Pos);   /* P0 - 0:PF0 1:SCL1 2:     3:     4:   7:XOUT */
