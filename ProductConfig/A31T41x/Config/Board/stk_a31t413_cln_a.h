/**
 *******************************************************************************
 * @file        stk_a31t413_cln_a.h
 * @author      ABOV R&D Division
 * @brief       STK (Startup Kit Board on which A31T413CLN is mounted)
 *
...
#ifndef _STK_A31T413_CLN_A_H_
#define _STK_A31T413_CLN_A_H_
...
/* SPI0 Port */
#define SPI0_SS_PORT                2    /* Port D */
#define SPI0_SS_PORT_ID             4
#define SPI0_SS_MUX_ID              3
#define SPI0_SCK_PORT               2    /* Port C */
#define SPI0_SCK_PORT_ID            3
#define SPI0_SCK_MUX_ID             3
#define SPI0_MOSI_PORT              2    /* Port C */
#define SPI0_MOSI_PORT_ID           1
#define SPI0_MOSI_MUX_ID            3
#define SPI0_MISO_PORT              2    /* Port C */
#define SPI0_MISO_PORT_ID           2
#define SPI0_MISO_MUX_ID            3

/* TIMER10 Port */
#define TIMER10_OUT0_PORT           4    /* Port E */
#define TIMER10_OUT0_PORT_ID        1
#define TIMER10_OUT0_MUX_ID         1
#define TIMER10_CAP0_PORT           4    /* Port E */
#define TIMER10_CAP0_PORT_ID        1
#define TIMER10_CAP0_MUX_ID         2
#define TIMER10_CAP1_PORT           4    /* Port E */
#define TIMER10_CAP1_PORT_ID        0
...
#define LED_ISEG10_ID               3    /* Port D */
#define LED_ISEG10_PORT_ID          2    
#define LED_ISEG10_MUX_ID           4

#define LED_ISEG11_ID               3    /* Port D */
#define LED_ISEG11_PORT_ID          2    
#define LED_ISEG11_MUX_ID           4

#define LED_ISEG12_ID               3    /* Port D */
#define LED_ISEG12_PORT_ID          2    
#define LED_ISEG12_MUX_ID           4

#define LED_ISEG13_ID               3    /* Port D */
#define LED_ISEG13_PORT_ID          2    
#define LED_ISEG13_MUX_ID           4

#define LED_ISEG14_ID               3    /* Port D */
#define LED_ISEG14_PORT_ID          2    
#define LED_ISEG14_MUX_ID           4

#define LED_ISEG15_ID               3    /* Port D */
#define LED_ISEG15_PORT_ID          2    
#define LED_ISEG15_MUX_ID           4
