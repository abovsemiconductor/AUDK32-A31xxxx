...
static __inline void PRV_PORT_Init(void)
{
    ...
    PA->MR1 = 0x00UL
              | (0x07UL << PCU_MR1_P1MUX_Pos)    /* P1 - 0:PB1 1:   2:RXD11 3:RXD12 4:SCL1 5:MOSI11 6:CS4 7:AN4/MS4/SXIN  */
              | (0x07UL << PCU_MR1_P0MUX_Pos);   /* P0 - 0:PB0 1:   2:TXD11 3:TXD12 4:SDA1 5:MISO11 6:CS5 7:AN5/MS5/SXOUT */
