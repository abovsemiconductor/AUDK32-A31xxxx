...
#
# E. Port Connection
#    1. PA4 (Slave Select)        <----> PB12 (Slave Select)
#    2. PA5 (Serial Clock)        <----> PB13 (Serial Clock)
#    3. PA7 (Master Out Slave In) <----> PB15 (Master Out Slave In)
#    4. PA6 (Master In Slave Out) <----> PB14 (Master In Slave Out)
#
...
# 1. Channel                   : 0 (SPI0)
#
# 2. Config                    : [ 0 i s 16 0 m h 120 -delay 1 1 1 ]
...
# 1. Channel                   : 1 (SPI1)
#
# 2. Config                    : [ 1 i m 16 0 m h 120 -delay 1 1 1 ]
#    Operation                 : i (Interrupt)
#    Mode                      : m (Master)
#    Data Length               : 16 (16bit)
#    Polarity/Phase            : 0 (Polarity : Low, Phase : Low)
...
send "config 0 i s 16 0 m h 120 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
...
send "config 1 i m 16 0 m h 120 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
