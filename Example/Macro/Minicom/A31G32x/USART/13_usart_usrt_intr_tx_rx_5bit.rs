...
# 1. Channel                   : 1 (USART1)
#
# 2. Config                    : [ 1 i a m 5 n 1 0 38400 ]
...
# 1. Channel                   : 2 (USART2)
#
# 2. Config                    : [ 2 i a s 5 n 1 0 38400 ]
#    Operation                 : i (Interrupt)
#    USART Mode                : a (USRT)
#    USRT Mode                 : s (Slave)
#    Data Bit                  : 5 (5bit)
...
send "config 2 i a s 5 n 1 0 38400"
expect {
    "<USART> # "
    break
    timeout 5 goto end
...
send "config 1 i a m 5 n 1 0 38400"
expect {
    "<USART> # "
    break
    timeout 5 goto end
...
send "data 1 8 0xaa 0x55 0x10 0x01 0xff 0x5a 0xa5 0xff"
expect {
    "<USART> # "
    break
    timeout 5 goto end
