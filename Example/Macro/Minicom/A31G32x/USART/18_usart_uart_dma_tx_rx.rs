...
#
# D. Default Port
#    1. USART1  : PA2 (Transmit)
#               : PA3 (Receive)
#    2. USART2  : PB10 (Transmit)
#               : PB11 (Receive)
#
# E. Port Connection
#    1. PA2 (Transmit) <----> PB11 (Receive)
#    2. PA3 (Receive)  <----> PB10 (Transmit)
#
...
# 1. Channel                   : 2 (USART2)
#
# 2. Config                    : [ 2 d u 8 n 1 n 38400 ]
#    Operation                 : d (Interrupt)
#    USART Mode                : u (UART)
#    Data Bit                  : 8 (8bit)
#    Parity                    : n (None)
#    Stop Bit                  : 1 (1bit)
...
#
# 2. Port                      : [ 0 2 a 0 -pupd p ] [ 0 3 a 0 -pupd p ]
#    Pin Number                : 2 / 3
...
#
# 2. Port                      : [ 1 10 a 0 -pupd p ] [ 1 11 a 0 -pupd p ]
#    Pin Number                : 10 / 11
#    Pin Mode                  : a (Alternative)
#    Alternative               : 0 (Tx/Rx)
#    Pull-up/down              : p (Pull-up)
...
send "config 2 d u 8 n 1 n 38400"
expect {
    "<USART> # "
    break
    timeout 5 goto end
...
send "config 1 d u 8 n 1 n 38400"
expect {
    "<USART> # "
    break
    timeout 5 goto end
