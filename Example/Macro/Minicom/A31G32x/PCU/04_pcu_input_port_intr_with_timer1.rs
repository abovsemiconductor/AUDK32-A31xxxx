...
#
# E. Port Connection
#    1. PB14 (Timer10 Output) ----> PA0 (Input)
#                             ----> PA1 (Input)
#                             ----> PB2 (Input)
#
...
#                                 : 1 (PCU Port B)
#
# 2. Port                         : [ 0 0 i i -intr i e r -pupd n ] [ 0 1 i i -intr i e r -pupd n ] [ 1 2 i i -intr i e r -pupd n ]
#    Pin Number                   : 0 / 1 / 2
#    Pin Mode                     : i (Input)
...
send "port 0 0 i i -intr i e r -pupd n"
expect {
    "<PCU> # "
    break
    timeout 5 goto end
...
# PCU (PA1)
send "port 0 1 i i -intr i e r -pupd n"
expect {
    "<PCU> # "
    break
    timeout 5 goto end
...
# PCU (PB2)
send "port 1 2 i i -intr i e r -pupd n"
expect {
    "<PCU> # "
    break
    timeout 5 goto end
