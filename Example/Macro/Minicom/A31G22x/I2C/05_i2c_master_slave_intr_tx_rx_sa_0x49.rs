...
#               : PD1 (Serial Data)
#    2. I2C1    : PA1 (Serial Clock)
#               : PA0 (Serial Data)
#
# E. Port Connection
#    1. PD0 (Serial Clock) <----> PA1 (Serial Clock)
#    2. PD1 (Serial Data)  <----> PA0 (Serial Data)
#
...
#
# 2. Port                      : [ 0 0 a 1 -pupd p ] [ 0 1 a 1 -pupd p]
#    Pin Number                : 0 / 1 
#    Pin Mode                  : a (Alternative)
