...
send "data 0 7 0x00 8 0x00 9 0x00 10 0x00 11 0x00 12 0x00 13 0x00 14 0x00"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
loop:
send "data 0 7 0x01 9 0x01 11 0x01 13 0x01"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 7 0x02 9 0x02 11 0x02 13 0x02"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 7 0x04 9 0x04 11 0x04 13 0x04"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 7 0x08 9 0x08 11 0x08 13 0x08"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 7 0x00 8 0x01 9 0x00 10 0x01 11 0x00 12 0x01 13 0x00"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 8 0x02 10 0x02 12 0x02 14 0x02"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 8 0x04 10 0x04 12 0x04 14 0x04"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 8 0x08 10 0x08 12 0x08 14 0x08"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
...
sleep 1
send "data 0 7 0x0F 8 0x0F 9 0x0F 10 0x0F 11 0x0F 12 0x0F 13 0x0F 14 0x0F"
expect {
    "<LCD> # "
    break
    timeout 5 goto end
