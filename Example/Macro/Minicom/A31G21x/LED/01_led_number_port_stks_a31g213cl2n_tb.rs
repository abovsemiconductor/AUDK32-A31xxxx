# A. Description
#    A list of commands here configure 7-segment(port mode) and displays a digit on it.
#
# B. Preparation
#    N/A
#
...
send "config 0 i p a 1 127 0 -overlap 32"
expect {
    "<LED> # "
    break
    timeout 5 goto end
...
# num 0 1 2 3
send "data 0 3 0x3F 4 0x06 5 0x5B 6 0x4F"
expect {
    "<LED> # "
    break
    timeout 5 goto end
...
# num 4 5 6 7
send "data 0 3 0x66 4 0x6D 5 0x7D 6 0x07"
expect {
    "<LED> # "
    break
    timeout 5 goto end
...
# num 8 9 . all
send "data 0 3 0x7F 4 0x6F 5 0x80 6 0xFF"
expect {
    "<LED> # "
    break
    timeout 5 goto end
